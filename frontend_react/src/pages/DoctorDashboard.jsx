...
const DoctorDashboard = () => {
    ...
    const fetchData = async () => {
        try {
            const statsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://healthnexus-c3sa.onrender.com'}/api/doctor/dashboard`);
            setStats(statsRes.data);

            const patientsRes = await axios.get(`${import.meta.env.VITE_API_URL || 'https://healthnexus-c3sa.onrender.com'}/api/doctor/patients`);
